...
M.mode = function()
  ...
  local mode_sep1 = "%#" .. M.modes[m][2] .. "Sepl#" .. sep_l .. "%#" .. M.modes[m][2] .. "# "
  ...
  if rawget(vim, "lsp") then
    for _, client in ipairs(vim.lsp.get_active_clients()) do
      if client.attached_buffers[vim.api.nvim_get_current_buf()] and client.name ~= "null-ls" then
        return "%#St_LspStatus#" .. ((vim.o.columns > 120 and "   LSP ~ " .. client.name .. " ") or "   LSP ")
      end
    end
  end
end
...
M.cwd = function()
  ...
  local dir_name = "%#St_gitIcons#" .. " 󰉋 " .. fn.fnamemodify(fn.getcwd(), ":t") .. " "
...
M.hotfix_hl = function()
  ...
  vim.api.nvim_set_hl(0, "St_EmptySep", {bg=hl['St_EmptySpace2'].bg, fg=hl['St_EmptySpace'].fg})
  vim.api.nvim_set_hl(0, "St_EmptySepSpace", {bg=pos_sep.bg, fg=hl['St_EmptySpace'].fg})
