...
M.load_config = function()
   local conf = require "as.core_config"
...
M.override_req = function(name, default_config, config_function)
   local override, apply_table_override =
      require("as.utils.core").load_config().plugins.default_plugin_config_replace[name], "false"
...
--   local override = require("as.utils.core").load_config().plugins.default_plugin_config_replace[name] or {}
...
M.remove_default_plugins = function(plugins)
   local removals = require("as.utils.core").load_config().plugins.default_plugin_remove or {}
...
--   local user_Plugins = require("as.utils.core").load_config().plugins.install or {}
